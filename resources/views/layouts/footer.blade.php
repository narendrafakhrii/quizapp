    ...
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
            ...
            <p class="text-sm leading-relaxed">
                {{ __('Alfabee is an interactive quiz platform for learning English in a fun and challenging way. Improve your vocabulary, grammar, and reading comprehension through diverse and progressive exercises.') }}
            </p>
        </div>
