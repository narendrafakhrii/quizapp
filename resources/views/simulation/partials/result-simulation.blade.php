...
<div x-show="showResult" x-cloak
    ...
    <div class="w-full max-w-6xl bg-white rounded-2xl shadow-lg p-6 border my-5">
        <div class="text-center mb-6 mt-6">
            <h2 class="text-2xl font-bold mb-2">Hasil Simulasi UTBK</h2>
            <p class="text-gray-600">Simulasi telah selesai. Berikut adalah hasil Anda:</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="text-center bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl p-6">
                <p class="text-sm opacity-90 mb-1">Skor Anda</p>
                <p class="text-4xl font-bold" x-text="finalScore"></p>
                <p class="text-sm opacity-90" x-text="'dari ' + questions.length * 4 + ' poin maksimal'"></p>
            </div>

            <!-- Statistics Grid -->
            <div class="grid grid-cols-2 gap-3">
                <div class="p-3 rounded-lg bg-green-50 border border-green-200 text-center">
                    <p class="text-xs text-green-600 mb-1">Benar</p>
                ...
                <div class="p-3 rounded-lg bg-red-50 border border-red-200 text-center">
                    <p class="text-xs text-red-600 mb-1">Salah</p>
                ...
                <div class="p-3 rounded-lg bg-gray-50 border border-gray-200 text-center">
                    <p class="text-xs text-gray-600 mb-1">Tidak Dijawab</p>
                ...
                <div class="p-3 rounded-lg bg-yellow-50 border border-yellow-200 text-center">
                    <p class="text-xs text-yellow-600 mb-1">Ragu-ragu</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                <h4 class="font-semibold mb-3">Analisis Performa</h4>
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-sm text-gray-600">Persentase Benar</span>
            ...
            <!-- Time Information -->
            <div>
                <h4 class="font-semibold mb-3">Informasi Waktu</h4>
                <div class="grid grid-cols-1 gap-3">
                    <div class="p-3 rounded-lg bg-blue-50 border border-blue-200">
                        <p class="text-xs text-blue-600 mb-1">Waktu Terpakai</p>
                    ...
                    <div class="p-3 rounded-lg bg-indigo-50 border border-indigo-200">
                        <p class="text-xs text-indigo-600 mb-1">Rata-rata per Soal</p>
                        <p class="text-sm font-semibold text-indigo-700" x-text="averageTimePerQuestion + ' detik'"></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-3">
            <button @click="showDetailedReview = true"
                class="px-6 py-2 rounded-lg border border-blue-600 text-blue-600 hover:bg-blue-50 transition-colors">
                Lihat Pembahasan
            </button>
