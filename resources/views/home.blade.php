...
<body class="flex flex-col min-h-screen">
    ...
    <main class="flex-grow">
        ...
        <div class="mt-10 flex items-center justify-center space-x-4 mb-8">
            <img src="{{ asset('assets/image/mascot.png') }}" class="w-10 h-10">
            <x-mascot-text class="w-full min-w-7md bg-gray-200 rounded-md p-4" />
        </div>

        <div class="flex flex-col mx-8">
            <h2 class="font-semibold lg:text-2xl mb-4">{{ __('home.start_new_learn') }}</h2>
            <x-card.primary-card>
                <div
                    ...
                    {{-- Course info --}}
                    <div class="mb-12">
                        <p class="text-sm text-white/70 mb-2 tracking-wider uppercase">{{ __('home.learn') }}</p>
                        <h3 class="text-3xl font-bold mb-4">{{ __('home.grammar') }}</h3>
                    </div>

                    <div class="mb-1">
                        <p class="text-sm text-white mb-2">
                            {{ __('home.quiz_description') }}
                        </p>
                    </div>
